...
<div class="container">
    ...
    {{-- Import Form --}}
    <form action="{{ route('manage.users.import') }}" method="POST" enctype="multipart/form-data" class="mb-4">
        @csrf
        ...
        <div class="mb-3">
            ...
            <div class="form-text">Download the <a href="{{ route('manage.users.import.template') }}" class="link-primary">template CSV here</a>.</div>
        </div>
