...
<div class="container">
    ...
    <div class="mb-3 d-flex justify-content-between">
        ...
        {{-- 
        <div>
            <a href="{{ route('admin.manage.users.export') }}" class="btn btn-success me-2">
            ...
            <tbody>
                @forelse($users as $user)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.manage.users.edit', $user->id) }}" class="btn btn-sm btn-warning me-1" title="Edit User" data-bs-toggle="tooltip" data-bs-placement="top">
                                <i class="fas fa-edit"></i> Edit
                            </a>

                            {{-- Password Generation Button (Optional) --}}
                            {{-- 
                            <form action="{{ route('admin.manage.users.generatePassword', $user->id) }}" method="POST" style="display:inline-block;">
                                @csrf
