...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('admin.outgoings.store') }}" method="POST">
            @csrf

            <div class="mb-3">
                <label for="control_no" class="form-label">Control No.</label>
                <input type="text" name="control_no" class="form-control" id="control_no" value="{{ old('control_no') }}" required>
            </div>

            <div class="mb-3">
                <label for="date_released" class="form-label">Date Released</label>
                <input type="date" name="date_released" class="form-control" id="date_released" value="{{ old('date_released') }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="addressed_to" class="form-control" id="addressed_to" value="{{ old('addressed_to') }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="subject_of_letter" class="form-control" id="subject_of_letter" value="{{ old('subject_of_letter') }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="libcap_no" class="form-control" id="libcap_no" value="{{ old('libcap_no') }}">
            </div>
            ...
            <button type="submit" class="btn btn-primary">Create Outgoing</button>
